...
VDOT_LAT <- 38.82320300122662 
VDOT_LON <- -77.33642591604617
...
shinyApp(
    ...
    ui = fluidPage(
        ...
        leafletOutput("MetricsMap", height = "800px"),
    ...
    server = function(input, output, session) {
        ...
        output$MetricsMap <- renderLeaflet({
            debug(logger, "renderLeaflet on []: output$MetricsMap")
            isolate({
                pal <- colorBin(
                    palette = "YlGnBu",
        ...
        observe({
            debug(logger, "observe on map_data(): MetricsMap_proxy")
        ...
        observeEvent(input$MetricsMap_click, {
            debug(logger, "observe on prev_row(): MetricsMap_proxy - remove marker")
        ...
        observeEvent(input$top10_table_rows_selected, {
            debug(logger, "observe event on input$top10_table_rows_selected: MetricsMap_proxy")
