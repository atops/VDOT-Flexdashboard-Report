...
conditionalPanel(
    ...
    selectInput("before_after_metric", "Metric:",
        choices = c(names(metrics_list), names(metrics_list_travel_times)),
...
observeEvent(input$before_date_range, {
    ...
    updateDateRangeInput(
        session,
        "after_date_range",
        start = max(input$after_date_range[1], input$before_date_range[2] + days(1)), 
...
observeEvent(input$after_date_range, {
    ...
    updateDateRangeInput(
        ...
        end = min(input$before_date_range[2], input$after_date_range[1] - days(1)))
}, ignoreInit = TRUE)
